...
let cerrarModal = () => {
    btnGuardar.setAttribute("data-bs-dismiss", "modal"); //Referencia al atributo
    btnGuardar.click();   
}
...
let mostrarTareas = () => {
    ...
    tareas.forEach((tarea, indice)=>{
        ...
        <div class='row' id=${indice}>
                ...
                <div class='box-description col-2 border p-3'>
...
let borrarTarea = (boton, indice) => {
    if(confirm('¿Estás segura de eliminar la tarea?')){
